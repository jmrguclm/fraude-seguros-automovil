...
The 'fraude_en_seguros_de_automovil' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] fraude_en_seguros_de_automovil_etl` to your workspace.
